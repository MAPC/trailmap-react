...
const ContributeModal = () => {
  ...
  return (
    ...
    >
      <Modal.Title>
        <span className="Modal__title text-center d-block mt-1 mb-1 ms-2 me-2 p-3 lh-lg">Contribute to Trailmap</span>
      </Modal.Title>
      <Modal.Body className="Modal__body text-center">
        <span>
          We welcome contributions to this map including adding to and editing the data! We have an online editing tool
          available for you to use. To found out how to access the editing functions, please contact David Loutzenheiser
          at:{" "}
