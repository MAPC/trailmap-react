  ...
  return (
    <div className="regional-trails-profile-map" style={{ width: '100%', height: '100%', position: 'relative', overflow: 'hidden' }}>
      ...
      {showControlPanel ? (
        <div>
          <ControlPanel 
            ...
            onToggleMajorTrail={(majorTrailName) => {
              ...
              handleZoomToProject(majorTrailName);
            }}
          ...
          <button
            type="button"
            className="ControlPanelEdgeToggle ControlPanelEdgeToggle--close"
            title="Collapse panel"
            aria-label="Collapse panel"
            onClick={() => toggleControlPanel(false)}
          >
        ...
        <button
          type="button"
          className="ControlPanelEdgeToggle ControlPanelEdgeToggle--open"
          title="Expand panel"
